...
import { signApprovalList } from 'src/lib/private-storage';
...
export async function GET(request: Request) {
  ...
  return NextResponse.json({ approvals: await signApprovalList(data ?? []) });
}
