...
export const paths = {
  ...
  teacher: {
    ...
    lessonPlans: {
      ...
      templateLibrary: `${ROOTS.TEACHER}/lesson-plans/template-library`,
      templateLibraryNew: `${ROOTS.TEACHER}/lesson-plans/template-library/new`,
      templateLibraryEdit: (id: string) =>
        `${ROOTS.TEACHER}/lesson-plans/template-library/${id}/edit`,
      edit: (id: string) => `${ROOTS.TEACHER}/lesson-plans/${id}/edit`,
    },
    lessonPlanReviews: `${ROOTS.TEACHER}/lesson-plan-reviews`,
    subjectRoot: `${ROOTS.TEACHER}/subject`,
    subjectNew: `${ROOTS.TEACHER}/subject/new`,
    subjectEdit: (id: string) => `${ROOTS.TEACHER}/subject/${id}/edit`,
