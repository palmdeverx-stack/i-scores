-- Store optional English subject content while keeping the existing columns
-- as the Thai/default values for backwards compatibility.
alter table public.subjects
  add column if not exists name_en text,
  add column if not exists description_en text;

-- Include the English name in assignment search and its embedded subject data.
