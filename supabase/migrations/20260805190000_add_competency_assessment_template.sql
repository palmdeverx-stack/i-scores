-- Add the reusable multi-domain competency assessment used by full lesson-plan templates.
...
alter table public.templates
  add constraint templates_template_type_check check (template_type in (
    ...
    'desired_characteristic', 'desired_characteristic_assessment',
    'learner_development', 'learning_task', 'lesson_plan'
  ));
